...
for current_file in all_files: 
	...
	if (current_file.endswith(".tgz")) or (current_file.endswith("tar.gz")):
		...
		#files=os.listdir(path) FileNotFoundError: [Errno 2] No such file or directory: '200'
		#files=glob.glob(path) PermissionError: [Errno 13] Permission denied: 'sample1/nvram2/logs'
		for file1 in files:
			print("Hi")
